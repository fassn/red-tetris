                ...
                {status === 'error' && (
                    <>
                        ...
                        <button
                            ...
                            className='mt-4 px-6 py-2 bg-brand rounded font-semibold uppercase hover:bg-brand-hover hover:text-content-inverse transition-colors focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2'
                        >
                            Retry
                        </button>
                    </>
