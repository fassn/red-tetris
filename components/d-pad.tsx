...
const DPad = ({ disabled }: DPadProps) => {
    ...
    const btn = 'flex items-center justify-center w-12 h-10 sm:w-16 sm:h-16 rounded-lg bg-surface-card border border-edge text-xl font-bold active:bg-brand active:text-content-inverse select-none transition-colors touch-manipulation'
